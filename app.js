...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className="incompleted__checkbox"
    //label
    var label=document.createElement("label");//label
    label.className="task incompleted__label";
    //input (text)
    var editInput=document.createElement("input");//text
    editInput.className="task incompleted__input";
    //button.edit
...
var taskCompleted=function(){
    ...
    var listItem=this.parentNode;
    listItem.children[1].className="task completed__label";
...
//Mark task as incomplete.
    ...
    var listItem=this.parentNode;
    listItem.children[1].className="task incompleted__label";
    incompleteTaskHolder.appendChild(listItem);
    bindTaskEvents(listItem,taskCompleted);
}
